...
import {MdDevices, MdBusinessCenter} from "react-icons/md"
    ...
    return (
        <div>
            <div className='selfService'>
                ...
                <div onClick={()=> {navigate("/selfservice/project")}} className='button-4 sm:w-full xs:w-full md:w-5/12'><MdBusinessCenter className='mx-auto text-4xl text-fourth'/> <p>Project</p></div>
                </div>
            </div>
            <Navbar />
        </div>
