    ...
    return (
        ...
        <div className="container my-5 tableView py-4 overflow-x-auto">
            ...
            <div className='button-5 font-semibold text-sm'  onClick={()=>{navigate('/selfservice/all-requests')}} > All Requests</div>
                ...
                <div className='button-5 font-semibold text-sm' style={{backgroundColor:"#3283bd"}} onClick={()=>{navigate('/selfservice/all-requests/vehicle')}}> Vehicle Requests</div>
                <div className='button-5 font-semibold text-sm' onClick={()=>{navigate('/selfservice/all-requests/assets')}}> Assets Requests</div>
             </div>
